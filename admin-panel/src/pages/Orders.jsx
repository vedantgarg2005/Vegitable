...
const STATUS_TABS = [
  ...
  { label: 'Preparing',     value: 'preparing',       icon: UtensilsCrossed,color: 'text-yellow-600', bg: 'bg-yellow-100' },
...
const ALL_STATUSES = ['placed', 'confirmed', 'preparing', 'ready', 'picked_up', 'out_for_delivery', 'delivered', 'cancelled'];
