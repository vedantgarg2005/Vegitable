                ...
                <tr key={review._id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${
                      review.isVerified ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                    }`}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        onClick={() => verifyMutation.mutate({ id: review._id, isVerified: !review.isVerified })}
                      ...
                      <button
                        title="Respond"
                        onClick={() => { setRespondModal(review); setResponseText(review.adminResponse?.message || ''); }}
                        className="p-1.5 rounded hover:bg-slate-100"
                      >
                      ...
                      <button
                        title="Delete"
                        onClick={() => { if (confirm('Delete this review?')) deleteMutation.mutate(review._id); }}
                        className="p-1.5 rounded hover:bg-slate-100"
                      >
